...
Provides reusable infinite scroll pagination primitives — a `useInfiniteScroll` hook and `<ScrollSentinel>` component — so any list page can implement scroll-based pagination without duplicating IntersectionObserver logic.
