# advanced-image-compression Specification

## Purpose

Provides client-side image compression optimized for OCR-based bill scanning — WebP-first output with JPEG fallback, reduced dimensions for faster uploads, and high-quality smoothing to preserve text clarity.
