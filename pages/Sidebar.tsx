      ...
      <aside className="relative h-full w-[85%] max-w-[320px] bg-white shadow-[20px_0_60px_rgba(0,0,0,0.05)] flex flex-col border-r border-gray-50 animate-in slide-in-from-left duration-300">
        <div className="pt-16 pb-10 px-8 bg-white">
          <div className="flex flex-col gap-5">
            ...
            >
                ...
                <div>
                <h2 className="text-3xl font-bold font-display tracking-tight text-slate-900 group-hover:text-primary transition-colors">{user?.name}</h2>
                <div className="flex items-center gap-2 mt-2">
                    {user?.isPremium && (
                        <span className="px-2 py-1 rounded-md bg-electric-blue/10 text-electric-blue text-[10px] font-bold uppercase tracking-wider">Premium</span>
                    )}
        ...
        <nav className="flex-1 overflow-y-auto hide-scrollbar px-5 py-2">
          <ul className="flex flex-col gap-2">
            ...
            <li>
              <button className="w-full flex items-center gap-5 px-5 py-4 rounded-2xl hover:bg-gray-50 transition-colors group text-slate-600">
                <Icon name="donut_large" className="text-electric-blue text-[22px] group-hover:scale-110 transition-transform" />
                <span className="text-[16px] font-medium group-hover:text-slate-900 transition-colors">Budget Analytics</span>
              </button>
            </li>
            <li>
              <button className="w-full flex items-center gap-5 px-5 py-4 rounded-2xl hover:bg-gray-50 transition-colors group text-slate-600">
                <Icon name="receipt_long" className="text-electric-blue text-[22px] group-hover:scale-110 transition-transform" />
                <span className="text-[16px] font-medium group-hover:text-slate-900 transition-colors">Transactions</span>
              </button>
            </li>
             <li>
              <button className="w-full flex items-center gap-5 px-5 py-4 rounded-2xl hover:bg-gray-50 transition-colors group text-slate-600">
                <Icon name="savings" className="text-electric-blue text-[22px] group-hover:scale-110 transition-transform" />
                <span className="text-[16px] font-medium group-hover:text-slate-900 transition-colors">Saving Goals</span>
              </button>
            </li>
          </ul>
          ...
          <ul className="flex flex-col gap-1">
            <li>
              <button onClick={() => { onClose(); navigate('/settings'); }} className="w-full flex items-center gap-5 px-5 py-3.5 rounded-2xl hover:bg-gray-50 transition-colors group text-slate-500">
            ...
            <li>
              <button className="w-full flex items-center gap-5 px-5 py-3.5 rounded-2xl hover:bg-gray-50 transition-colors group text-slate-500">
                ...
                <span className="text-[15px] font-medium group-hover:text-slate-800 transition-colors">Help Center</span>
              </button>
            </li>
          </ul>
        </nav>
